...
class BodyFourTablet extends StatefulWidget {
  const BodyFourTablet({Key? key}) : super(key: key);

  @override
  _BodyFourTabletState createState() => _BodyFourTabletState();
}

class _BodyFourTabletState extends State<BodyFourTablet> {
  @override
                    ...
                    children: [
                      Row(
                        children: [
                          Padding(
                            padding:
                                const EdgeInsets.only(left: 150, top: 20.0),
                            child: Container(
                              child: Column(
                                children: [
                                  const CircleAvatar(
