...
class BrandBodyDesktop extends StatefulWidget {
  const BrandBodyDesktop({Key? key}) : super(key: key);

  @override
  _BrandBodyDesktopState createState() => _BrandBodyDesktopState();
}

class _BrandBodyDesktopState extends State<BrandBodyDesktop> {
