...
class BrandBodyTab extends StatefulWidget {
  const BrandBodyTab({Key? key}) : super(key: key);

  @override
  _BrandBodyTabState createState() => _BrandBodyTabState();
}

class _BrandBodyTabState extends State<BrandBodyTab> {
