...
import 'package:tradex/BoiWidgets/Boi_Moble_Views/boi_body_mobile.dart';
...
class BoiNavbarMobile extends StatefulWidget {
  const BoiNavbarMobile({Key? key}) : super(key: key);

  @override
  _BoiNavbarMobileState createState() => _BoiNavbarMobileState();
}

class _BoiNavbarMobileState extends State<BoiNavbarMobile> {
  @override
