...
class BoiBodyMobile extends StatefulWidget {
  const BoiBodyMobile({Key? key}) : super(key: key);

  @override
  _BoiBodyMobileState createState() => _BoiBodyMobileState();
}

class _BoiBodyMobileState extends State<BoiBodyMobile> {
