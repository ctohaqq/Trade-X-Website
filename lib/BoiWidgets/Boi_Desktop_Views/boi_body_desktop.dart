...
class BoiBodyDesktop extends StatefulWidget {
  const BoiBodyDesktop({Key? key}) : super(key: key);

  @override
  _BoiBodyDesktopState createState() => _BoiBodyDesktopState();
}

class _BoiBodyDesktopState extends State<BoiBodyDesktop> {
