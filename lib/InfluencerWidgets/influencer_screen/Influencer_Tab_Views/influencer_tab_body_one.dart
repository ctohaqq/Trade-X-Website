...
class InfluencerTabBodyOne extends StatefulWidget {
  const InfluencerTabBodyOne({Key? key}) : super(key: key);

  @override
  _InfluencerTabBodyOneState createState() => _InfluencerTabBodyOneState();
}

class _InfluencerTabBodyOneState extends State<InfluencerTabBodyOne> {
