...
import 'package:tradex/InfluencerWidgets/influencer_screen/Influencer_Tab_Views/influencer_tab_body_one.dart';
import 'package:tradex/Routes/routes.dart';
import 'package:tradex/constants/colors.dart';
import 'package:velocity_x/src/extensions/context_ext.dart';

class InfluencerNavbarTab extends StatefulWidget {
  const InfluencerNavbarTab({Key? key}) : super(key: key);

  @override
  _InfluencerNavbarTabState createState() => _InfluencerNavbarTabState();
}

class _InfluencerNavbarTabState extends State<InfluencerNavbarTab> {
  @override
