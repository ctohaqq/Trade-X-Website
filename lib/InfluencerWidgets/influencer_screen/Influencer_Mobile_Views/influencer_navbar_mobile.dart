...
class InfluencerNavbarMobile extends StatefulWidget {
  const InfluencerNavbarMobile({Key? key}) : super(key: key);

  @override
  _InfluencerNavbarMobileState createState() => _InfluencerNavbarMobileState();
}

class _InfluencerNavbarMobileState extends State<InfluencerNavbarMobile> {
  @override
