...
class FreelancerBodyOneDesktop extends StatefulWidget {
  const FreelancerBodyOneDesktop({Key? key}) : super(key: key);

  @override
  _FreelancerBodyOneDesktopState createState() =>
      _FreelancerBodyOneDesktopState();
}

class _FreelancerBodyOneDesktopState extends State<FreelancerBodyOneDesktop> {
