...
class FreelancerBodyOneTab extends StatefulWidget {
  const FreelancerBodyOneTab({Key? key}) : super(key: key);

  @override
  _FreelancerBodyOneTabState createState() => _FreelancerBodyOneTabState();
}

class _FreelancerBodyOneTabState extends State<FreelancerBodyOneTab> {
