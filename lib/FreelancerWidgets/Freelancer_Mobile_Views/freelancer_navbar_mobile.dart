...
import 'package:tradex/FreelancerWidgets/Freelancer_Mobile_Views/freelancer_body_one_mobile.dart';
...
class FreelanceNavbarMobile extends StatefulWidget {
  const FreelanceNavbarMobile({Key? key}) : super(key: key);

  @override
  _FreelanceNavbarMobileState createState() => _FreelanceNavbarMobileState();
}

class _FreelanceNavbarMobileState extends State<FreelanceNavbarMobile> {
  @override
