...
class ProductHeaderDesktop extends StatefulWidget {
  const ProductHeaderDesktop({Key? key}) : super(key: key);

  @override
  _ProductHeaderDesktopState createState() => _ProductHeaderDesktopState();
}

class _ProductHeaderDesktopState extends State<ProductHeaderDesktop> {
                    ...
                    child: Column(
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(
                            'wiht Businesses, Influencers, Freelancers and more on a single platform',
                            textAlign: TextAlign.center,
